...
<head>
    ...
    {{-- 3D Card Tilt Script (vanilla JS, lightweight) --}}
    <script>
    ...
    <style>
        /* Floating animation for bg orbs */
        @keyframes float {
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8 lg:py-40">
            <div class="max-w-3xl">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="https://wa.me/{{ $empresa?->sucursales()->where('activo', true)->orderBy('id')->first()?->telefono ?? '51999999999' }}" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-white/20 bg-white/5 backdrop-blur-sm px-8 py-4 text-base font-black text-white transition-all duration-300 hover:bg-white/15 hover:border-white/40 hover:-translate-y-1 active:translate-y-0">
                ...
                <div data-3d-tilt class="group relative overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-700/80 bg-white dark:bg-slate-800/60 p-6 shadow-sm transition-shadow hover:shadow-xl sm:col-span-2">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm leading-6 text-slate-600 dark:text-slate-400">Contáctanos directamente por WhatsApp o visítanos. Estamos listos para ayudarte con lo que necesites.</p>
                        </div>
                    </div>
                </div>
            </div>
