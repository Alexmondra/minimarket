<div class="space-y-8 animate-fade-in">
            ...
            @foreach ($presentaciones as $p)
                <div class="group relative flex flex-col bg-white dark:bg-[#0d111f] rounded-2xl border border-slate-200/80 dark:border-[#1d2745]/60 shadow-md hover:shadow-xl hover:border-indigo-500/50 dark:hover:border-indigo-400/50 transition-all duration-300 hover:-translate-y-1 overflow-hidden cursor-pointer"
                    ...
                    <div class="aspect-video w-full overflow-hidden bg-slate-100/80 dark:bg-slate-900/60 relative border-b border-slate-200/50 dark:border-[#1d2745]/40 flex items-center justify-center">
                        ...
                        @php
                            $tieneSucursales = $p->productoSucursales->isNotEmpty() || $p->lotePresentaciones->isNotEmpty();
                        @endphp
                        @if ($tieneSucursales)
                            <button type="button"
                                    class="absolute top-2 right-2 p-1.5 rounded-lg bg-white/90 dark:bg-slate-950/80 text-slate-400 dark:text-slate-600 border border-slate-200 dark:border-[#1d2745]/60 opacity-0 group-hover:opacity-100 transition duration-300 shadow-sm z-10 cursor-not-allowed"
                                    title="No se puede eliminar: asignada a sucursal(es)">
                        ...
                        @else
                            <button type="button"
                                    wire:click.stop="confirmDelete({{ $p->id }})"
                 ...
                 <div class="p-6 space-y-6">
                     ...
                     <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100 dark:border-[#1d2745]/30">
                         ...
                         <button type="button" 
                                 ...
                                 class="px-5 py-2.5 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 rounded-xl shadow-md transition duration-200">
                             💾 Guardar Cambios
                         </button>
                     </div>
                 </div>
    ...
    <template x-teleport="body">
        <div x-data="{ openPresentationModal: @entangle('showModal') }" 
             x-show="openPresentationModal" 
             x-cloak
             class="fixed inset-0 z-[60] flex items-center justify-center p-4 overflow-y-auto"
             style="display: none;">
             ...
             <!-- Backdrop/Overlay -->
             <div class="fixed inset-0 bg-slate-950/60 backdrop-blur-sm transition-opacity"
                  @click="openPresentationModal = false"
                         ...
                         <div class="space-y-5">
                             ...
                             <div class="space-y-2">
                                 ...
                                 <div class="flex flex-col items-center justify-center border border-dashed border-slate-300 dark:border-[#1d2745]/60 bg-slate-50/50 dark:bg-slate-900/10 rounded-2xl p-4 text-center relative hover:bg-slate-50 dark:hover:bg-slate-900/20 transition group">
                                     ...
                                     <span class="text-xs font-bold text-indigo-650 dark:text-indigo-400 group-hover:underline">Subir Archivo</span>
                             ...
                             <div class="space-y-2">
                                 ...
                                 <div class="flex gap-2">
                                     ...
                                     <button type="button" 
                                             ...
                                             class="inline-flex items-center justify-center p-2 bg-indigo-650 hover:bg-indigo-600 active:bg-indigo-700 text-white rounded-xl shadow transition duration-200 shrink-0">
    ...
    <!-- MODAL CONFIRMAR ELIMINACIÓN DE PRESENTACIÓN -->
    <template x-teleport="body">
        <div x-data="{ openDeletePres: @entangle('showDeleteModal') }" 
             x-show="openDeletePres" 
             x-cloak
             class="fixed inset-0 z-[60] flex items-center justify-center p-4 overflow-y-auto"
             style="display: none;">
             ...
             <div class="relative bg-white dark:bg-[#0c101d] border border-slate-200 dark:border-[#1c243a] rounded-3xl w-full max-w-md overflow-hidden shadow-2xl transition-all animate-fade-in my-8 z-10">
                 ...
                 <div class="p-6 text-center space-y-4">
                     <div class="inline-flex p-3.5 bg-rose-500/10 text-rose-600 dark:text-rose-400 rounded-full border border-rose-500/20">
                     ...
                     <div class="space-y-1.5">
                         <h3 class="text-base font-extrabold text-slate-900 dark:text-white">¿Eliminar presentación?</h3>
                         <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                             Esta acción es irreversible y eliminará todos los códigos de barra asociados a esta variante.
                         </p>
                     </div>
                 </div>
