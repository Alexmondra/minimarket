    ...
    <div class="space-y-6 animate-fade-in">
        ...
        <div class="relative overflow-hidden p-5 rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-600 shadow-xl shadow-sky-500/20 dark:from-sky-700 dark:to-indigo-800">
            ...
            <div class="relative flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl font-black text-white tracking-tight">Nuevo Proveedor</h1>
                    <p class="text-sm text-white/70 mt-0.5">Registra un nuevo proveedor en el sistema</p>
                </div>
            </div>
        </div>
