        ...
        <div class="relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-xl shadow-amber-500/25 dark:from-amber-700 dark:to-orange-800">
            ...
            <div class="relative flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <h1 class="text-2xl font-black text-white tracking-tight truncate">Editando: {{ $this->getRecord()?->nombre }}</h1>
                    <p class="text-sm text-white/70 mt-0.5 font-medium">Modifica los datos del proveedor</p>
                </div>
                <div class="shrink-0">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/15 text-white text-xs font-bold ring-1 ring-white/20">
                        #{{ $this->getRecord()?->id }}
                    </span>
                </div>
            </div>
